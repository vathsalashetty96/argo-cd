PACKAGE=github.com/vathsalashetty25/argo-cd/common
...
DOCKER_WORKDIR?=/go/src/github.com/vathsalashetty25/argo-cd
...
LEGACY_PATH=$(GOPATH)/src/github.com/vathsalashetty25/argo-cd
ifeq ("$(PWD)","$(LEGACY_PATH)")
DOCKER_SRC_MOUNT="$(DOCKER_SRCDIR):/go/src$(VOLUME_MOUNT)"
else
DOCKER_SRC_MOUNT="$(PWD):/go/src/github.com/vathsalashetty25/argo-cd$(VOLUME_MOUNT)"
endif
