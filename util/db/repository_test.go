...
func TestRepoURLToSecretName(t *testing.T) {
	tables := map[string]string{
		"git://git@github.com:vathsalashetty96/ARGO-cd.git": "repo-83273445",
		"https://github.com/vathsalashetty96/ARGO-cd":       "repo-1890113693",
		"https://github.com/vathsalashetty96/argo-cd":       "repo-42374749",
		"https://github.com/vathsalashetty96/argo-cd.git":   "repo-821842295",
		"https://github.com/vathsalashetty96/argo_cd.git":   "repo-1049844989",
		"ssh://git@github.com/vathsalashetty96/argo-cd.git": "repo-3569564120",
	}
...
func Test_CredsURLToSecretName(t *testing.T) {
	tables := map[string]string{
		"git://git@github.com:vathsalashetty96":  "creds-2483499391",
		"git://git@github.com:vathsalashetty96/": "creds-1465032944",
		"git@github.com:vathsalashetty96":        "creds-2666065091",
		"git@github.com:vathsalashetty96/":       "creds-346879876",
	}
