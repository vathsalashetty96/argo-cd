...
func (ctrl *ApplicationController) getResourceTree(a *appv1.Application, managedResources []*appv1.ResourceDiff) (*appv1.ApplicationTree, error) {
	...
	hosts, err := ctrl.getAppHosts(a, nodes, err)
	if err != nil {
		return nil, err
	}
...
func (ctrl *ApplicationController) getAppHosts(a *appv1.Application, appNodes []appv1.ResourceNode, err error) ([]appv1.HostInfo, error) {
