...
go build -i -o dist/go-to-protobuf ./cmd/go-to-protobuf
go build -i -o dist/protoc-gen-gogo ./cmd/go-to-protobuf/protoc-gen-gogo
...
go build -o dist/go-to-protobuf ./cmd/go-to-protobuf
. /dist/go-to-protobuf \
